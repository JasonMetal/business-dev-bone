...
`business-dev-bone/pkg/component-base/shutdown` documentation is available on [godoc](http://godoc.org/business-dev-bone/pkg/component-base/shutdown).

Both `ShutdownManagers` are also documented:
- [`PosixSignalManager`](http://godoc.org/business-dev-bone/pkg/component-base/shutdown/shutdownmanagers/posixsignal)
- [`AwsManager`](http://godoc.org/business-dev-bone/pkg/component-base/shutdown/shutdownmanagers/awsmanager)
...
import (
	...
	"business-dev-bone/pkg/component-base/shutdown/shutdownmanagers/awsmanager"
