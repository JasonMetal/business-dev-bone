...
type ObjectMeta struct {
	...
	// created. It is not guaranteed to be set in happens-before order across separate  business-dev-bone.
	...
	// Read-only.
	// Null for lists.
	UpdateTime time.Time `json:"-" gorm:"column:update_time;not null"`
	...
	// Read-only.
	DeletedAt gorm.DeletedAt `json:"-" gorm:"column:delete_time;index:idx_deletedAt"`

	CreateBy string `json:"createBy,omitempty" gorm:"column:create_by;type:varchar(64)"`
	UpdateBy string `json:"updateBy,omitempty" gorm:"column:update_by;type:varchar(64)"`

	CreatedTime int64 `json:"createdTime,omitempty" gorm:"-"`
	UpdatedTime int64 `json:"updatedTime,omitempty" gorm:"-"`
}
...
func (obj *ObjectMeta) AfterFind(tx *gorm.DB) error {
	if !obj.CreateTime.IsZero() {
		obj.CreatedTime = obj.CreateTime.UnixMilli()
	}
	if !obj.UpdateTime.IsZero() {
		obj.UpdatedTime = obj.UpdateTime.UnixMilli()
	}
	return nil
}
...
type ListOptions struct {
	...
	PageNo *int64 `json:"pageNo,omitempty" form:"pageNo"`

	// PageSize specify the number of records to be retrieved.
