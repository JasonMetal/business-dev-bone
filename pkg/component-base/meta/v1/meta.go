...
import (
	...
	"business-dev-bone/pkg/component-base/scheme"
)
...
func (meta *ObjectMeta) GetCreatedAt() time.Time          { return meta.CreateTime }
func (meta *ObjectMeta) SetCreatedAt(createdAt time.Time) { meta.CreateTime = createdAt }
func (meta *ObjectMeta) GetUpdatedAt() time.Time          { return meta.UpdateTime }
func (meta *ObjectMeta) SetUpdatedAt(updatedAt time.Time) { meta.UpdateTime = updatedAt }
